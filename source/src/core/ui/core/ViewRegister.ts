...
import { ComCurrencyProxy } from "../viewCtrlProxy/PkgCommon/Coms/ComCurrencyProxy";
...
class ViewRegister {
    ...
    private registerView() {
		...
		//Coms
		register(ViewID.ComCurrencyView, ComCurrencyView, ComCurrencyCtrl, ComCurrencyProxy);
